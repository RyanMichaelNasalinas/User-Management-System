    ...
    <div id="page-content-wrapper">
        ...
        <?php
            if (isset($_POST['register'])) {
                ...
                //Message
                $msg = $validation->check_empty($_POST, ['firstname', 'lastname', 'age', 'gender', 'username', 'password', 'confirm_password', 'email']);
                if ($msg != null) {
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio2" name="gender" value="Male" class="custom-control-input">
                                    <label class="custom-control-label" for="customRadio2">Male</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio3" name="gender" value="Female" class="custom-control-input">
